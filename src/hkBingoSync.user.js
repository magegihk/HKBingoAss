...
$(document).ready(function () {
  ...
  var rollTranslate = {
		...
		"Get 2 Dreamer's checks (Requires Dream nail)":"得2守梦处东西",
    ...
    var rollTips = {
		...
		"Nosk":"诺斯克",
		"Pale Lurker":"苍白潜伏者",
		"Any one Radiant Boss":"任意一个辐辉级Boss",
		"Soul Master":"灵魂大师",
		"Soul Tyrant":"灵魂暴君",
		"Traitor Lord":"叛徒领主",
		...
		"Get 2 Dreamer's checks (Requires Dream nail)":"获得两个守梦者处的东西（需要梦钉）",
		...
		"Read both Pilgrim's Way lore tablets":"阅读朝圣者之路的2个石碑（苍绿真菌）",
		...
		"Swat Tiso's shield away from his corpse":"打飞提索尸体的盾",
		"Talk to Tuk":"和图克对话",
		"Visit Distant Village or Hive":"拜访遥远村庄或蜂巢",
		"Visit Lake of Unn or Blue Lake":"拜访乌恩之湖或蓝湖",
		"Visit Overgrown Mound or Crystalised Mound (Crystalised requires dive)":"拜访长满植物的山丘或结晶山丘",
